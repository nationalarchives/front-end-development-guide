...
You are using ARIA role 'main' which is fine.
...
No forms used in this template, therefore all checks fine.
...
No SVG is used for this template.
...
All CSS checks are fine. No additional styling has been added.
...
No additional js been added to the template.
