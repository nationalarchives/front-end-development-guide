...
bxSlider plugin is used for the scrolling banner.
If disable the js the style of the banner rotator looks a bit wired. I don't see a real problem in here because the content is visible.
