...
http://places-of-deposit.azurewebsites.net/results.php?region=east%20of%20england#eastengland
http://places-of-deposit.azurewebsites.net/place-of-deposit.php?id=31
Search results returned with no indentation - can this be changed? Otherwise all other areas are ok.
...
Optional tags used. Closing tags used. All tags and attributes are in lower case.
...
http://places-of-deposit.azurewebsites.net/
No H1 heading although there is an H2. Consider re-tagging the main heading as an H1 of finding a suitable H1 heading.
Other pages are ok.
...
Main elements used on all templates.
Sectioning elements used slightly inconsistently. Possibly use always DIVs or always SECTIONs for the main area of the page.
No further ARIA landmarks needed.
...
No back to top link is available. Add version from TNA site.
...
No forms present in this prototype
...
http://places-of-deposit.azurewebsites.net/transferring-body.php?id=400
Table in this page needs amending to use tbody tags. It also needs a caption and scope attribute added.
